...
if(isset($_GET['email'])){
  $datos= $conexion->query("SELECT 
          ...
          WHERE usuario.email='".$_GET['email']."'")or die(header("Location: ./"));
          
  $datosUsuario = mysqli_fetch_row($datos);

  $datos2= $conexion -> query("SELECT * FROM envios 
  INNER JOIN ventas ON envios.id_venta=ventas.id INNER JOIN usuario ON usuario.id = ventas.id_usuario  WHERE usuario.email='".$_GET['email']."'")or die(header("Location: ./"));
  ...
  $datos3= $conexion -> query("SELECT productos_venta.*,
          ...
          WHERE  usuario.email='".$_GET['email']."' AND ventas.id='".$_GET['idventa']."'
            ...
            <form action="#" method="post">
              ...
              <div class="p-3 p-lg-5 border">
                <div class="form-group row">
                  <div class="col-md-6">
                    <label for="c_fname" class="text-black">Orden de Venta #<?php echo $_GET['idventa']; ?></label>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-6">
